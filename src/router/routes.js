...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/users/analytics/:agentId', name: 'user_analystics', component: () => import('pages/UserAnalyticsPage.vue') },
      ...
      { path: '/agentstate', component: () => import('pages/AgentStateDashboardPage.vue') }
    ]
  },
